...
const Annotations = () => {
  ...
  const handleSendAnnotationsVideos = async () => {
    ...
    if (videosToSend.length === 0) {
      console.log("No videos attached to annotations.");
      return;
    }

    //const endpoint = `${FLASK_URL}/video/send`;
    const endpoint = `${HUB_BASE_URL}upload.py`;
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Sync Button */}
      <TouchableOpacity style={styles.syncButton} onPress={handleSendAnnotationsVideos}>
